...
from infrastructure.launch_lambda import launch_lambda
...
def launch_lambda(stage: str = "prod"):
    ...
    ecr = launch_ecr(
        repository_name="humidity_process", container_path="./lambda"
    )

    launch_lambda(
        lambda_name="humidity_process",
        lambda_timeout=300, # Probably need to adjust this
        lambda_memory=1024, # Probably need to adjust this
        lambda_handler="download_lambda",
