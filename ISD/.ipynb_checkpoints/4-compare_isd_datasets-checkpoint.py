...
had_stn = hadley[['station_id','longitude','latitude']].drop_duplicates()
had_stn=had_stn.reset_index()
had_stn=had_stn[["station_id","longitude","latitude"]]

#had_stn.to_parquet('s3://ncai-humidity/had-isd/hadley_stations.parquet',index=False)
